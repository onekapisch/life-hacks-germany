...
steps:
  - "Check whether you are a mandatory filer (Pflichtveranlagung) — common triggers include simultaneous employers, certain income not subject to wage-tax withholding, or wage-replacement benefits subject to progression whose positive annual total exceeds EUR 410."
  ...
  - "If using a Steuerberater or Lohnsteuerhilfeverein, confirm they are tracking your return. For the 2025 return, the weekend-adjusted filing deadline is March 1, 2027."
facts:
...
sources:
  ...
  - label: "EStG Section 46 (EUR 410 annual filing trigger)"
...
For the **2025 tax year**, February 28 falls on a Sunday. Under the weekend rule in §108(3) AO, the practical extended deadline is therefore **March 1, 2027**.
...
- The positive annual total of income or benefits subject to the progression clause exceeded **EUR 410**; this can include Kurzarbeitergeld, Elterngeld, Krankengeld, or Mutterschaftsgeld
...
If you arrived in Germany in 2023 and are eligible to file voluntarily, you can generally still file that 2023 return until December 31, 2027. Whether a refund results depends on the complete tax case; a partial employment year can affect the calculation but does not guarantee a refund.

File earlier rather than later and monitor ELSTER or post for follow-up questions. Processing times vary by Finanzamt and case complexity, so do not plan around a fixed refund date.
