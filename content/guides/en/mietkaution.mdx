...
faqs:
  - q: "How much is the maximum rent deposit (Mietkaution) in Germany?"
    a: "Under Section 551 BGB, the maximum rent deposit is three months of Kaltmiete (cold rent, excluding Nebenkosten operating costs). For example, if your cold rent is EUR 900/month, the maximum deposit is EUR 2,700. Any demand above this cap is legally void — even if you signed a contract with a higher amount."
  - q: "Can I pay the German rent deposit in installments?"
    a: "Yes — you have a statutory right under Section 551 BGB to pay the deposit in three equal monthly installments, regardless of what the contract says. The first installment is due at move-in, the second after one month, and the third after two months. A contract clause requiring full upfront payment cannot override this legal right."
  - q: "How do I get my rent deposit back when I move out in Germany?"
    a: "After moving out, the landlord has up to 6 months to return the deposit or provide written justification for deductions. Legitimate deductions include unpaid rent, unpaid Nebenkosten, and documented damage beyond normal wear and tear. Normal wear (faded paint, minor scuffs) cannot be deducted. If the deposit is not returned without justification, send a formal demand letter (Mahnung) with a 14-day deadline. Keep your signed move-in protocol (Uebergabeprotokoll) as evidence."
sources:
