...
faqs:
  - q: "What are the most important things to do in the first two weeks after moving to Germany?"
    a: "The critical first-14-day tasks are: 1) Complete Anmeldung (address registration) — legally required within 14 days and needed for everything else. 2) Open a German bank account — required for salary, rent, and direct debits. 3) Arrange health insurance — mandatory before your first working day. 4) Obtain a Steuer-ID — automatically sent to your registered address within 2-4 weeks of Anmeldung."
  - q: "Can I open a German bank account before doing Anmeldung?"
    a: "Some online banks (N26, Vivid, Revolut) do not require an Anmeldung address proof and can be opened with a passport before registration. Traditional German banks (Deutsche Bank, Commerzbank, Sparkasse) typically require the Anmeldebestaetigung. Opening a digital bank account first, then switching to a traditional account after Anmeldung, is a common approach."
  - q: "How long does it take to get a Steuer-ID after Anmeldung?"
    a: "Your Steuer-ID (11-digit tax identification number) is automatically assigned by the Bundeszentralamt fuer Steuern and sent by post to your registered address within 2-4 weeks of Anmeldung. It is issued once and does not change even if you move. You can also apply online via the official portal if you have not received it."
sources:
...
## Why do the first 14 days in Germany matter so much?
...
## How do I open a German bank account as a new arrival?
