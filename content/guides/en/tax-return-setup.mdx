...
faqs:
  ...
  - q: "What is the deadline for filing a tax return in Germany?"
    a: "For the 2025 tax year: if filing yourself, the statutory deadline is July 31, 2026. With a registered Steuerberater (tax advisor), the deadline extends to the end of February 2027. For voluntary (non-mandatory) returns, you have four years from the assessment year end."
