---
title: "Deutschlandticket: Preis, Gültigkeit, Grenzen"
summary: "Das Deutschlandticket ist ein Monatsabo für den Nahverkehr in ganz Deutschland. Hier steht, was drin ist und was nicht."
pillar: mobility
slug: deutschlandticket
published: "2026-03-23"
updated: "2026-09-05"
forWho: "Pendler, Studierende und alle, die regelmässig regional fahren."
costs: "63 Euro pro Monat (aktueller Listenpreis)."
localNotes: "Kündigungsregeln variieren je Anbieter."
...
mistakes:
  ...
  - "Anbieter-Fristen für die Kündigung übersehen."
sources:
  ...
  - label: "Deutsche Bahn: Kündigungsfrist des Deutschlandtickets"
    url: "https://www.bahn.de/faq/deutschlandticket-kuendigen"
  - label: "Deutsche Bahn: Preis des Deutschlandticket Jobtickets 2026"
...
**Stadtpendler-Beispiel:** Den heutigen Einzeltarif in der App des eigenen Verkehrsverbunds nachsehen und mit der tatsächlichen monatlichen Fahrtenzahl multiplizieren. Bei 22 Pendeltagen mit Hin- und Rückfahrt 44 Einzelfahrten mit 63 Euro vergleichen und Arbeitgeberzuschüsse oder lokale Abos berücksichtigen.

**Regionales Reisebeispiel:** Die tatsächlich wiederkehrende Regionalstrecke im offiziellen Reiseplaner bepreisen. Diese Fahrten zu den lokalen Mobilitätskosten addieren und die Monatssumme mit 63 Euro vergleichen. Keine alte Streckenpreisschätzung weiterverwenden, weil sich Regionaltarife ändern können.

**Wenig-Nutzungs-Szenario:** Bei nur gelegentlicher Nutzung die aktuell tatsächlich benötigten Einzeltickets summieren. Bleibt der Betrag unter 63 Euro und ist der Komfort den Aufpreis nicht wert, sind Einzeltickets günstiger.
...
**Manche Banken und Arbeitgeber:** DKB, Commerzbank und einige Arbeitgeber-Benefitprogramme bieten das Deutschlandticket über eigene Portale an. Wichtig: nachfragen, ob der Arbeitgeber ein subventioniertes **Jobticket** anbietet. Nach den DB-Konditionen 2026 reduziert der 5-%-Rabatt der Verkehrsunternehmen den Listenpreis von 63 Euro auf 59,85 Euro, wenn der Arbeitgeber mindestens 25 % des Listenpreises zuschießt. Beschäftigte zahlen dann höchstens **44,10 Euro/Monat**. Bei HR nachfragen, ob der Betrieb dieses Modell anbietet.
...
Das Deutschlandticket ist ein **Monatsabonnement**, kein Einzelkauf. Kündigungsfristen sind anbieterabhängig und sollten vor dem Kauf geprüft werden.

**DB-Kündigungsfrist:** Bis zum **10. Kalendertag des Monats** kündigen, damit das Abo zum Ende dieses Monats endet. Eine Kündigung nach dem 10. wirkt erst zum Ende des Folgemonats. Beispiel: Ein nach dem 10. Januar gekauftes DB-Abo kann nicht zum 31. Januar beendet werden; frühestes Ende ist der 28. Februar.

**Lokale Anbieter-Fristen variieren:** Anbieter-AGB vor dem Abschluss lesen und nicht automatisch von der DB-Frist ausgehen.
