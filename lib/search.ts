...
const STATIC_PAGES = {
  ...
  de: [
    {
      title: "Start hier",
      summary: "Personalisierter Weg für Expats, Studierende und Residents.",
      href: "/de/start-here",
      kind: "page" as const,
      section: "onboarding",
    ...
    },
    {
      ...
      summary: "Erste 30 Tage, Gehaltsorientierung, Familien-Setup und bessere Fragen für HR oder Payroll.",
    ...
    {
      title: "Alle Guides",
      summary: "Alle verifizierten Schritt-für-Schritt Guides nach Themen.",
      href: "/de/guides",
      kind: "page" as const,
      section: "guides",
      keywords: "guides bürokratie geld steuern wohnen mobilität alltag",
    },
    {
      title: "Tipps & Hacks",
      summary: "Kurze, praktische Workflows für den Alltag in Deutschland.",
      href: "/de/tips",
      kind: "page" as const,
      section: "tips",
    ...
    },
    {
      ...
      summary: "Monatliche Updates für Expats, Studierende und Locals.",
      href: "/de/blog",
      kind: "page" as const,
      section: "blog",
      keywords: "blog updates monatliche änderungen deutschland 2026 gesetz preis visum steuer verkehr",
    },
    {
    ...
    {
      title: "Tools & Rechner",
      summary: "Interaktive Rechner für Gehalt, Miete, Steuer und Planung.",
      href: "/de/tools",
      kind: "page" as const,
      section: "tools",
      keywords:
    ...
    },
    {
      ...
      kind: "page" as const,
      section: "about",
      keywords: "über uns mission verifizierung",
    },
    {
    ...
    {
      title: "Datenschutz",
      summary: "Datenschutzerklärung, Analyse und Newsletterdaten.",
...
const TOOL_ENTRIES: Record<Lang, StaticSearchEntry[]> = {
  ...
  de: [
    {
      title: "Last Train Home + Weekend Escape Finder",
      summary: "Späte Heimfahrten finden und Wochenendtrips nach Dauer, Wetter und Preis-Fit sortieren.",
      href: "/de/tools#last-train-weekend-escape",
      kind: "tool",
      section: "tools",
      keywords:
        "letzter zug heimweg wochenendtrip finder deutschland bahn spät nacht rückfahrt wetter budget",
    },
    {
      title: "Brutto-Netto + Stadt-Überschuss Rechner",
      summary: "Nettogehalt schätzen und Monatsplus in zwei deutschen Städten vergleichen.",
      href: "/de/tools/gross-net-salary-calculator",
      kind: "tool",
      section: "tools",
      keywords:
        "brutto netto rechner stadt lebenshaltungskosten berlin münchen hamburg frankfurt köln steuerklasse",
    },
    {
      title: "Warmmiete-Quote Rechner",
      summary: "Prüfen, ob deine Warmmiete in einem gesunden Bereich liegt.",
    ...
    },
    {
      ...
      summary: "Einzeltickets und Monatsabo vergleichen für den günstigeren Pendelweg.",
      href: "/de/tools#ticket-cost-comparison",
      kind: "tool",
      section: "tools",
      keywords: "deutschlandticket abo öpnv ticket vergleich",
    },
    {
      title: "Steuererstattungs-Schätzer",
      summary: "Mögliche Rückerstattung aus Einkommen, Pendelweg und Absetzungen abschätzen.",
      href: "/de/tools#tax-return-savings",
      kind: "tool",
      section: "tools",
      keywords: "steuererklärung rückerstattung elster absetzungen",
    },
    {
      title: "Einzugsbudget-Planer",
      summary: "Startkosten für Wohnung inklusive Kaution, erste Miete und Einrichtung planen.",
    ...
    },
    {
      ...
      summary: "Benötigte Sperrkonto-Summe und Finanzierungslücke berechnen.",
    ...
    },
    {
      ...
      summary: "Spätesten sicheren Starttermin für Verlängerung festlegen.",
      href: "/de/tools#permit-timeline",
      kind: "tool",
      section: "tools",
      keywords: "aufenthaltstitel verlängerung frist termin",
    },
  ],
};
